...
class CFRequest extends RequestCore
{
    ...
    public function __construct(
        $url = null, $proxy = null, $helpers = null,
        CFCredential $credentials = null
    ) {
        ...
        $this->cacert_location = ($this->credentials['certificate_authority']
            ? $this->credentials['certificate_authority'] : false);
