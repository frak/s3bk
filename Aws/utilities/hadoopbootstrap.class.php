...
class CFHadoopBootstrap extends CFHadoopBase
{
    ...
    public static function run_if($condition, $args = null)
    {
        ...
        return self::script_runner(
            's3://us-east-1.elasticmapreduce/bootstrap-actions/run-if', $args
        );
    }
    ...
    public static function configure($file, $config)
    {
        ...
        return self::script_runner(
            's3://us-east-1.elasticmapreduce/bootstrap-actions/configure-hadoop',
            $args
        );
    }
    ...
    public static function daemon($daemon_type, $opt = null)
    {
        ...
        return self::script_runner(
            's3://us-east-1.elasticmapreduce/bootstrap-actions/configure-daemons',
            $args
        );
    }
}
