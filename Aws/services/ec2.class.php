...
class AmazonEC2 extends CFRuntime
{
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function associate_dhcp_options(
        $dhcp_options_id, $vpc_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function associate_route_table(
        $subnet_id, $route_table_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function attach_internet_gateway(
        $internet_gateway_id, $vpc_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
    ...
    public function attach_volume(
        $volume_id, $instance_id, $device, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function cancel_spot_instance_requests(
        $spot_instance_request_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
        ...
        $opt = array_merge(
            $opt, CFComplexType::map(
            array(
                'SpotInstanceRequestId' => (is_array($spot_instance_request_id)
                    ? $spot_instance_request_id
                    : array($spot_instance_request_id))
            )
        )
        );
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function confirm_product_instance(
        $product_code, $instance_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function create_customer_gateway(
        $type, $ip_address, $bgp_asn, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
    ...
    public function create_dhcp_options($dhcp_configuration, $opt = null)
    {
        ...
        $opt = array_merge(
            $opt, CFComplexType::map(
            array(
                'DhcpConfiguration' => (is_array($dhcp_configuration)
                    ? $dhcp_configuration : array($dhcp_configuration))
            )
        )
        );
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function create_network_acl_entry(
        $network_acl_id, $rule_number, $protocol, $rule_action, $egress,
        $cidr_block, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
    ...
    public function create_route(
        $route_table_id, $destination_cidr_block, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function create_security_group(
        $group_name, $group_description, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
    ...
    public function create_tags($resource_id, $tag, $opt = null)
    {
        ...
        $opt = array_merge(
            $opt, CFComplexType::map(
            array(
                'ResourceId' => (is_array($resource_id) ? $resource_id
                    : array($resource_id))
            )
        )
        );
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function create_vpn_connection(
        $type, $customer_gateway_id, $vpn_gateway_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function delete_network_acl_entry(
        $network_acl_id, $rule_number, $egress, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
    ...
    public function describe_addresses($opt = null)
    {
        ...
        if (isset($opt['PublicIp'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'PublicIp' => (is_array($opt['PublicIp']) ? $opt['PublicIp']
                        : array($opt['PublicIp']))
                )
            )
            );
        ...
        if (isset($opt['AllocationId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'AllocationId' => (is_array($opt['AllocationId'])
                        ? $opt['AllocationId'] : array($opt['AllocationId']))
                )
            )
            );
    ...
    public function describe_availability_zones($opt = null)
    {
        ...
        if (isset($opt['ZoneName'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'ZoneName' => (is_array($opt['ZoneName']) ? $opt['ZoneName']
                        : array($opt['ZoneName']))
                )
            )
            );
    ...
    public function describe_bundle_tasks($opt = null)
    {
        ...
        if (isset($opt['BundleId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'BundleId' => (is_array($opt['BundleId']) ? $opt['BundleId']
                        : array($opt['BundleId']))
                )
            )
            );
    ...
    public function describe_customer_gateways($opt = null)
    {
        ...
        if (isset($opt['CustomerGatewayId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'CustomerGatewayId' => (is_array($opt['CustomerGatewayId'])
                        ? $opt['CustomerGatewayId']
                        : array($opt['CustomerGatewayId']))
                )
            )
            );
    ...
    public function describe_dhcp_options($opt = null)
    {
        ...
        if (isset($opt['DhcpOptionsId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'DhcpOptionsId' => (is_array($opt['DhcpOptionsId'])
                        ? $opt['DhcpOptionsId'] : array($opt['DhcpOptionsId']))
                )
            )
            );
    ...
    public function describe_images($opt = null)
    {
        ...
        if (isset($opt['ImageId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'ImageId' => (is_array($opt['ImageId']) ? $opt['ImageId']
                        : array($opt['ImageId']))
                )
            )
            );
        ...
        if (isset($opt['Owner'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'Owner' => (is_array($opt['Owner']) ? $opt['Owner']
                        : array($opt['Owner']))
                )
            )
            );
        ...
        if (isset($opt['ExecutableBy'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'ExecutableBy' => (is_array($opt['ExecutableBy'])
                        ? $opt['ExecutableBy'] : array($opt['ExecutableBy']))
                )
            )
            );
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function describe_instance_attribute(
        $instance_id, $attribute, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
    ...
    public function describe_instance_status($opt = null)
    {
        ...
        if (isset($opt['InstanceId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'InstanceId' => (is_array($opt['InstanceId'])
                        ? $opt['InstanceId'] : array($opt['InstanceId']))
                )
            )
            );
    ...
    public function describe_internet_gateways($opt = null)
    {
        ...
        if (isset($opt['InternetGatewayId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'InternetGatewayId' => (is_array($opt['InternetGatewayId'])
    ...
    public function describe_key_pairs($opt = null)
    {
        ...
        if (isset($opt['KeyName'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'KeyName' => (is_array($opt['KeyName']) ? $opt['KeyName']
                        : array($opt['KeyName']))
                )
            )
            );
    ...
    public function describe_licenses($opt = null)
    {
        ...
        if (isset($opt['LicenseId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'LicenseId' => (is_array($opt['LicenseId'])
                        ? $opt['LicenseId'] : array($opt['LicenseId']))
                )
            )
            );
            unset($opt['LicenseId']);
    ...
    public function describe_network_acls($opt = null)
    {
        ...
        if (isset($opt['NetworkAclId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'NetworkAclId' => (is_array($opt['NetworkAclId'])
                        ? $opt['NetworkAclId'] : array($opt['NetworkAclId']))
                )
            )
            );
    ...
    public function describe_placement_groups($opt = null)
    {
        ...
        if (isset($opt['GroupName'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'GroupName' => (is_array($opt['GroupName'])
                        ? $opt['GroupName'] : array($opt['GroupName']))
                )
            )
            );
            unset($opt['GroupName']);
    ...
    public function describe_regions($opt = null)
    {
        ...
        if (isset($opt['RegionName'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'RegionName' => (is_array($opt['RegionName'])
                        ? $opt['RegionName'] : array($opt['RegionName']))
                )
            )
            );
    ...
    public function describe_reserved_instances($opt = null)
    {
        ...
        if (isset($opt['ReservedInstancesId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'ReservedInstancesId' => (is_array(
                        $opt['ReservedInstancesId']
                    ) ? $opt['ReservedInstancesId']
                        : array($opt['ReservedInstancesId']))
                )
            )
            );
    ...
    public function describe_reserved_instances_offerings($opt = null)
    {
        ...
        if (isset($opt['ReservedInstancesOfferingId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'ReservedInstancesOfferingId' => (is_array(
    ...
    public function describe_route_tables($opt = null)
    {
        ...
        if (isset($opt['RouteTableId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'RouteTableId' => (is_array($opt['RouteTableId'])
                        ? $opt['RouteTableId'] : array($opt['RouteTableId']))
                )
            )
            );
    ...
    public function describe_security_groups($opt = null)
    {
        ...
        if (isset($opt['GroupId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'GroupId' => (is_array($opt['GroupId']) ? $opt['GroupId']
                        : array($opt['GroupId']))
                )
            )
            );
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function describe_snapshot_attribute(
        $snapshot_id, $attribute, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
    ...
    public function describe_snapshots($opt = null)
    {
        ...
        if (isset($opt['SnapshotId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'SnapshotId' => (is_array($opt['SnapshotId'])
                        ? $opt['SnapshotId'] : array($opt['SnapshotId']))
                )
            )
            );
        ...
        if (isset($opt['RestorableBy'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'RestorableBy' => (is_array($opt['RestorableBy'])
                        ? $opt['RestorableBy'] : array($opt['RestorableBy']))
                )
            )
            );
    ...
    public function describe_spot_instance_requests($opt = null)
    {
        ...
        if (isset($opt['SpotInstanceRequestId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'SpotInstanceRequestId' => (is_array(
                        $opt['SpotInstanceRequestId']
                    ) ? $opt['SpotInstanceRequestId']
                        : array($opt['SpotInstanceRequestId']))
                )
            )
            );
    ...
    public function describe_spot_price_history($opt = null)
    {
        ...
        if (isset($opt['StartTime'])) {
            $opt['StartTime'] = $this->util->convert_date_to_iso8601(
                $opt['StartTime']
            );
        }
        ...
        if (isset($opt['EndTime'])) {
            $opt['EndTime'] = $this->util->convert_date_to_iso8601(
                $opt['EndTime']
            );
        }
        ...
        if (isset($opt['InstanceType'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'InstanceType' => (is_array($opt['InstanceType'])
                        ? $opt['InstanceType'] : array($opt['InstanceType']))
                )
            )
            );
        ...
        if (isset($opt['ProductDescription'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'ProductDescription' => (is_array(
                        $opt['ProductDescription']
                    ) ? $opt['ProductDescription']
                        : array($opt['ProductDescription']))
                )
            )
            );
    ...
    public function describe_subnets($opt = null)
    {
        ...
        if (isset($opt['SubnetId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'SubnetId' => (is_array($opt['SubnetId']) ? $opt['SubnetId']
                        : array($opt['SubnetId']))
                )
            )
            );
    ...
    public function describe_volumes($opt = null)
    {
        ...
        if (isset($opt['VolumeId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'VolumeId' => (is_array($opt['VolumeId']) ? $opt['VolumeId']
                        : array($opt['VolumeId']))
                )
            )
            );
    ...
    public function describe_vpcs($opt = null)
    {
        ...
        if (isset($opt['VpcId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'VpcId' => (is_array($opt['VpcId']) ? $opt['VpcId']
                        : array($opt['VpcId']))
                )
            )
            );
    ...
    public function describe_vpn_connections($opt = null)
    {
        ...
        if (isset($opt['VpnConnectionId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'VpnConnectionId' => (is_array($opt['VpnConnectionId'])
                        ? $opt['VpnConnectionId']
                        : array($opt['VpnConnectionId']))
                )
            )
            );
    ...
    public function describe_vpn_gateways($opt = null)
    {
        ...
        if (isset($opt['VpnGatewayId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'VpnGatewayId' => (is_array($opt['VpnGatewayId'])
                        ? $opt['VpnGatewayId'] : array($opt['VpnGatewayId']))
                )
            )
            );
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function detach_internet_gateway(
        $internet_gateway_id, $vpc_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
    ...
    public function get_console_output($instance_id, $opt = null)
    {
        ...
        $response = $this->authenticate(
            'GetConsoleOutput', $opt, $this->hostname
        );
        ...
        if (!isset($opt['DecryptPasswordWithKey'])) {
            ...
            if ($this->util->is_base64($data)) {
                ...
                if (openssl_private_decrypt(
                    base64_decode($data), $decrypted, $private_key
                )) {
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function import_key_pair(
        $key_name, $public_key_material, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
        $opt['KeyName']           = $key_name;
        $opt['PublicKeyMaterial'] = $this->util->is_base64($public_key_material)
            ? $public_key_material : base64_encode($public_key_material);
    ...
    public function modify_image_attribute($image_id, $opt = null)
    {
        ...
        if (isset($opt['UserId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'UserId' => (is_array($opt['UserId']) ? $opt['UserId']
                        : array($opt['UserId']))
                )
            )
            );
        ...
        if (isset($opt['UserGroup'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'UserGroup' => (is_array($opt['UserGroup'])
                        ? $opt['UserGroup'] : array($opt['UserGroup']))
                )
            )
            );
            unset($opt['UserGroup']);
        ...
        if (isset($opt['ProductCode'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'ProductCode' => (is_array($opt['ProductCode'])
                        ? $opt['ProductCode'] : array($opt['ProductCode']))
                )
            )
            );
    ...
    public function monitor_instances($instance_id, $opt = null)
    {
        ...
        $opt = array_merge(
            $opt, CFComplexType::map(
            array(
                'InstanceId' => (is_array($instance_id) ? $instance_id
                    : array($instance_id))
            )
        )
        );
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function purchase_reserved_instances_offering(
        $reserved_instances_offering_id, $instance_count, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function replace_network_acl_association(
        $association_id, $network_acl_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function replace_network_acl_entry(
        $network_acl_id, $rule_number, $protocol, $rule_action, $egress,
        $cidr_block, $opt = null
    ) {
        if (!$opt) {
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function replace_route_table_association(
        $association_id, $route_table_id, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
    ...
    public function request_spot_instances($spot_price, $opt = null)
    {
        ...
        if (isset($opt['ValidFrom'])) {
            $opt['ValidFrom'] = $this->util->convert_date_to_iso8601(
                $opt['ValidFrom']
            );
        }
        ...
        if (isset($opt['ValidUntil'])) {
            $opt['ValidUntil'] = $this->util->convert_date_to_iso8601(
                $opt['ValidUntil']
            );
        }
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function reset_instance_attribute(
        $instance_id, $attribute, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
     ...
     * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
     */
    public function reset_snapshot_attribute(
        $snapshot_id, $attribute, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
    ...
    public function run_instances(
        $image_id, $min_count, $max_count, $opt = null
    ) {
        if (!$opt) {
            $opt = array();
        }
        ...
        if (isset($opt['SecurityGroup'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'SecurityGroup' => (is_array($opt['SecurityGroup'])
                        ? $opt['SecurityGroup'] : array($opt['SecurityGroup']))
                )
            )
            );
        ...
        if (isset($opt['SecurityGroupId'])) {
            $opt = array_merge(
                $opt, CFComplexType::map(
                array(
                    'SecurityGroupId' => (is_array($opt['SecurityGroupId'])
                        ? $opt['SecurityGroupId']
                        : array($opt['SecurityGroupId']))
                )
            )
            );
